...
"   * g:airline#themes#custom#palette.normal 
"       * the colors for a statusline while in normal mode
"   * g:airline#themes#custom#palette.normal_modified 
"       * the colors for a statusline while in normal mode when the buffer has
"         been modified
"   * g:airline#themes#custom#palette.visual 
...
" let g:airline#themes#custom#palette.normal = {
...
" applied after g:airline#themes#custom#palette.normal, hence why only certain keys are
" declared.
...
let g:airline#themes#custom#palette.commandline = airline#themes#generate_color_map(s:airline_a_commandline, s:airline_b_commandline, s:airline_c_commandline)
